...
## 1. Executive summary
- Thời gian chạy: 2026-07-11T17:23:01.942Z → 2026-07-11T17:29:23.073Z
- RUN_ID: `E2E_REFUND_1783790581939_jbcg49`
...
Quản lý nhân viên
Cài đặt
Chi tiết đơn | RF-A06-missing-id.png |  |  |
...
| RF-B06 | Mapping dữ liệu bản ghi | FAIL | code/status/money/date hiển thị hợp lệ | code=TH-100001; status=Hoàn tất; firstCodeProbe=TH-100001; issues=mojibake | RF-B05-table.png |  |  |
| RF-B07 | Format null/undefined/NaN | FAIL | Không undefined/null/NaN/[object Object] | issues=["mojibake"]; snippet checks on page text |  |  |  |
...
| RF-C01 | Tìm theo mã trả hàng | PASS | q=exact code; kết quả liên quan | code=TH-100001; params={"channel":"store","page":"1","limit":"15","q":"TH-100001"}; shown=["TH-100001","TH-100002","TH-100003"] | RF-C01-code.png |  |  |
...
| RF-C10 | Không tìm thấy | FAIL | Empty state / total 0 | empty=0; summary=3
...
- (không có)
### MEDIUM
#### BUG-RF-001 — Format null/undefined/NaN
- Severity: MEDIUM
- Test: RF-B07
- Expected: Không undefined/null/NaN/[object Object]
- Actual: issues=["mojibake"]; snippet checks on page text
- Evidence: 
- Notes: 
- Source hint: xem component refund liên quan
- Nhận định: **fact** nếu actual/evidence quan sát được; inference chỉ khi ghi chú.

### LOW
- (không có)

## 9. Network report
- Methods: {"GET":317,"POST":1,"PUT":0,"PATCH":0,"DELETE":0,"OTHER":0}
- 4xx count: 0
- 5xx count: 1
- requestfailed: 148
...
- Artifact root: `e2e-artifacts/refund-audit/E2E_REFUND_1783790581939_jbcg49/`
