...
import { AlertCircle, Check, Eye, Filter, MoreHorizontal, Plus, Printer, RefreshCw, Search, X } from 'lucide-react';
...
export function WarehouseTransferPage() {
  ...
  const [confirm, setConfirm] = useState<{ row: TransferRow; action: 'confirm-source' | 'confirm-destination' | 'delete'; title: string; message: string } | null>(null);
