...
import { CashTransaction } from '../src/modules/accounting/accounting.models.js';
...
async function main() {
    ...
    const csvPath = path.join(__dirname, '../../Bảng dữ liệu/Nhanh.vn_Transaction_Cash_2026-06-05_135231.csv');
    ...
    for (const t of transactions) {
        await CashTransaction.findOneAndUpdate({ transactionId: t.transactionId }, t, { upsert: true });
    }
